...
export TF_VAR_data_disk_count_secondary_crm_ascs="${DATA_DISK_COUNT_CRM_ASCS}"
export TF_VAR_data_disk_count_secondary_crm_db="${DATA_DISK_COUNT_CRM_DB}"
export TF_VAR_data_disk_count_secondary_isu_ascs="${DATA_DISK_COUNT_ISU_ASCS}"
export TF_VAR_data_disk_count_secondary_isu_db="${DATA_DISK_COUNT_ISU_DB}"
export TF_VAR_data_disk_size_secondary_crm_ascs="${DATA_DISK_SIZE_CRM_ASCS}"
export TF_VAR_data_disk_size_secondary_crm_db="${DATA_DISK_SIZE_CRM_DB}"
export TF_VAR_data_disk_size_secondary_isu_ascs="${DATA_DISK_SIZE_ISU_ASCS}"
export TF_VAR_data_disk_size_secondary_isu_db="${DATA_DISK_COUNT_ISU_DB}"
...
export TF_VAR_network_security_group_name_app="${NETWORK_SECURITY_GROUP_APP}"
export TF_VAR_network_security_group_name_data="${NETWORK_SECURITY_GROUP_DATA}"
