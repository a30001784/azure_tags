...
resource "azurerm_virtual_machine_extension" "prepare_winrm_2016" {
    ...
    type                  = "CustomScriptExtension"
    type_handler_version  = "1.8"
    depends_on            = ["azurerm_virtual_machine.app","azurerm_virtual_machine.app-swd","azurerm_virtual_machine.ascs","azurerm_virtual_machine.db-crm","azurerm_virtual_machine.db-isu"]
